...
public class AltaPago {
    ...
    public AltaPago(int Id, String First_Name, String Last_Name, int Period, Date Date, int Year, float Amount, float Deduction, String Deduction_Details, float Bonus) {
        this.Id = Id;
        this.First_Name = First_Name;
        this.Last_Name = Last_Name;
        this.Period = Period;
