...
public class Personal extends javax.swing.JFrame {
    ...
    public Personal() {
       ...
       id.setText(""+obtenerIdPersonal());
       id.setEnabled(false);
    }
            Metodos_Altas Metodos;

    private int obtenerIdPersonal() {
    int f = this.Metodos.consultaIdPersonal();
    return f;
  }
...
JOptionPane.showMessageDialog(null, "Please fill all fields", "empty fields", 1);    } else {
      AltaPersonal prod = new AltaPersonal();
      prod.setId(Integer.parseInt(id.getText()));
      prod.setFirst_Name(nombre.getText());
      prod.setLast_Name(apellido.getText());
      
      
      (new puenteAltas()).PuenteRegistroPersonal(prod);
      
     id.setText("");
     nombre.setText("");
     apellido.setText("");
      this.id.setText("" + obtenerIdPersonal());
      nombre.requestFocus();
