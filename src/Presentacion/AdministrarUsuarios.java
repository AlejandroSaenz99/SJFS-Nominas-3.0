...
Modificable md=new Modificable();
md.setVisible(true);

md.MostrarTablaCamion();


md.Tr.setBackground(Color.green);
...
md.MostrarTablaTrailer();

md.Tra.setBackground(Color.green);
...
Modificable md=new Modificable();
md.setVisible(true);  
md.MostrarTablaChofer();


md.Dr.setBackground(Color.green);
